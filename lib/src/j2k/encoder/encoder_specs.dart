import '../entropy/c_blk_size_spec.dart';
...
class EncoderSpecs {
  ...
  EncoderSpecs(
      this.nTiles, this.nComp, BlkImgDataSrc imgsrc, ParameterList pl) {
    // ROI: as in JJ2000, the max-shift values are filled in later by the
    // ROIScaler; only the empty spec is created here.
